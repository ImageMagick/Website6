...
<pre class="bg-light text-dark"><code>gradient:
gradient:color1-color2
</code></pre>

<p> The for a radial gradient, the operator is either:</p>

<pre class="bg-light text-dark"><code>radial-gradient:
...
<pre class="bg-light text-dark"><code>convert -size 256x256 gradient: linear_gradient.png
...
<pre class="bg-light text-dark"><code>convert -size 256x256 radial-gradient: radial_gradient.png
...
<pre class="bg-light text-dark"><code>convert -size 256x128 -define gradient:direction=north gradient:black-white linear_gradient_default.png
...
<pre class="bg-light text-dark"><code>convert -size 128x256 gradient: -rotate 90 linear_gradient_east.png
</code></pre>

<p>can be generate by either of the following (or by reversing the direction and swapping color1 and color2):</p>

<pre class="bg-light text-dark"><code>convert -size 256x128 -define gradient:direction=east gradient:black-white linear_gradient_east.png
...
<pre class="bg-light text-dark"><code>convert -size 256x128 radial-gradient:black-white radial_gradient_maximum.png
...
<pre class="bg-light text-dark"><code>convert -size 256x128 -define gradient:extent=minimum radial-gradient:black-white radial_gradient_minimum.png
...
<pre class="bg-light text-dark"><code>convert -size 256x128 -define gradient:extent=diagonal radial-gradient:black-white radial_gradient_diagonal.png
</code></pre>
<p><img src="/script/../image/gradients/radial_gradient_diagonal.png" width="256" height="128"></p>

<pre class="bg-light text-dark"><code>convert -size 256x128 -define gradient:extent=ellipse radial-gradient:black-white radial_gradient_ellipse.png
...
<pre class="bg-light text-dark"><code>convert -size 256x256 -define gradient:radii=128,64 -define gradient:angle=45 radial-gradient:black-white radial_gradient_ellipse_angle45.png
</code></pre>
