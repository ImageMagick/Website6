...
<pre class="bg-light"><code>display rose.jpg
</code></pre>

<p>To tile a slate texture onto the root window, use:</p>

<pre class="bg-light"><code>display -size 1280x1024 -window root slate.png
</code></pre>

<p>To display a visual image directory of all your JPEG images, use:</p>

<pre class="bg-light"><code>display 'vid:*.jpg'
</code></pre>
...
<pre class="bg-light"><code>display -density 72 drawing.svg
</code></pre>
