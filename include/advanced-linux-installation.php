...
<pre class="bg-light text-dark"><code>tar xvzf ImageMagick.tar.gz
</code></pre>
...
<pre class="pre-scrollable bg-light text-dark"><code>ImageMagick is configured as follows. Please verify that this configuration
...
<pre class="bg-light text-dark"><code>configure CC=c99 CFLAGS=-O2 LDFLAGS='-L/usr/local/lib -R/usr/local/lib' LIBS=-lposix
</code></pre>
...
<table class="table table-sm table-hover">
  ...
  <br /><br />
<pre class="bg-light text-dark">Quantum Depth     Valid Range (Decimal)   Valid Range (Hex)
    8             0-255                   00-FF
  ...
  <br /><br />
<pre class="bg-light text-dark">Quantum Depth   Virtual Memory
     8               3MB
    16               8MB
    32              15MB
</pre></td>
...
<pre class="bg-light text-dark"><code>make
</code></pre>
...
<pre class="bg-light text-dark"><code>make install
</code></pre>
...
<pre class="bg-light text-dark"><code>$ convert logo: logo.gif
$ identify logo.gif
</code></pre>
...
<pre class="bg-light text-dark"><code>identify -list configure
</code></pre>

<p>To list which image formats are supported , type:</p>

<pre class="bg-light text-dark"><code>identify -list format
</code></pre>

<p>For a more comprehensive test, you run the ImageMagick test suite by typing:</p>

<pre class="bg-light text-dark"><code>make check
</code></pre>
...
<pre class="bg-light text-dark"><code>rpmbuild --rebuild ImageMagick.src.rpm
</code></pre>
...
<pre class="bg-light text-dark"><code>$ sudo port -v install freetype +bytecode
...
<pre class="bg-light text-dark"><code>sudo port install jpeg
</code></pre>
...
<pre class="bg-light text-dark"><code>./configure --prefix=/opt --with-quantum-depth=16 \
...
<pre class="bg-light text-dark"><code>sudo make install
</code></pre>
  <p>To verify your install, type</p>

<pre class="bg-light text-dark"><code>/opt/local/bin/identify -list font
</code></pre>

  <p>to list all the fonts ImageMagick knows about.</p>
	  <p>To test the ImageMagick GUI, in a new shell, type:</p>

<pre class="bg-light text-dark"><code>display -display :0
</code></pre>
...
<pre class="bg-light text-dark"><code>yum install libjpeg libjpeg-devel
</code></pre>
