...
<ul><pre class="bg-light text-dark"><code>convert objects.gif -connected-components 4 -auto-level -depth 8 objects.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert objects.gif -define connected-components:verbose=true -connected-components 4 objects.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert objects.gif -define connected-components:area-threshold=410 -connected-components 4 \
...
<ul><pre class="bg-light text-dark"><code>convert star-map.png -fuzz 5% -define connected-components:verbose=true \
