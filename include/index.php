...
<p>The authoritative ImageMagick version 6 web site is <a href="https://legacy.imagemagick.org/">https://legacy.imagemagick.org</a>. The authoritative source code repository is <a href="https://github.com/ImageMagick">https://github.com/ImageMagick</a>.  We maintain a source code mirror at <a href="https://gitlab.com/ImageMagick/ImageMagick/tree/ImageMagick-6">https://gitlab.com/ImageMagick/ImageMagick/tree/ImageMagick-6</a>.</p>
...
<p>As an analog to linear (RGB) and non-linear (sRGB) color colorspaces, as of ImageMagick 7.0.7-16, we introduce the LinearGray colorspace.  Gray is non-linear grayscale and LinearGray is linear (e.g. -colorspace linear-gray).</p>
