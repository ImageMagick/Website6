...
<p>The main website for legacy ImageMagick can be found at <a href="https://legacy.imagemagick.org">https://legacy.imagemagick.org</a>. The most recent version available is <a href="<?php echo $_SESSION['RelativePath']?>/../script/download.php">ImageMagick <?php echo MagickLibVersionText . MagickLibSubversion; ?></a>. The source code for this software can be accessed through the <a href="https://github.com/ImageMagick/ImageMagick6" rel="noopener noreferrer" target="_blank">repository</a>. We recommend upgrading your legacy version of ImageMagick to <a href="https://imagemagick.org">version 7</a>.</p>
...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tr>
    ...
    <td><a href="http://legacy.imagemagick.org/Usage/transform/#canny">Canny edge detection</a>, <a href="<?php echo $_SESSION['RelativePath']?>/../script/command-line-options.php#hough-line">Hough lines</a>.</td>
  </tr>
  <tr>
...
<br/>
<p><a href="https://legacy.imagemagick.org/Usage/" rel="noopener noreferrer" target="_blank">Examples of ImageMagick Usage</a> demonstrates how to use the software from the <a href="<?php echo $_SESSION['RelativePath']?>/../script/command-line-processing.php">command line</a> to achieve various effects. There are also several scripts available on the website called <a href="http://www.fmwconcepts.com/imagemagick/" rel="noopener noreferrer" target="_blank">Fred's ImageMagick Scripts</a>, which can be used to apply geometric transforms, blur and sharpen images, remove noise, and perform other operations. Additionally, there is a tool called <a href="https://github.com/dlemstra/Magick.NET" rel="noopener noreferrer" target="_blank">Magick.NET</a> that allows users to access the functionality of ImageMagick without having to install the software on their own systems. Finally, the website also includes a <a href="http://im.snibgo.com/" rel="noopener noreferrer" target="_blank">Cookbook</a> with tips and examples for using ImageMagick on Windows systems.</p>

<h3><a class="anchor" id="community"></a>Community</h3>
<p>Join the ImageMagick community by participating in the <a href="https://github.com/ImageMagick/ImageMagick6/discussions" rel="noopener noreferrer" target="_blank">discussion</a> service. Here, you can find answers to questions asked by other ImageMagick users or ask your own questions. If you have a technical question, a suggestion for an improvement, or a fix for a bug, you can also open an <a href="https://github.com/ImageMagick/ImageMagick6/issues" rel="noopener noreferrer" target="_blank">issue</a> to get help from the community.</p>
