...
<p>The authoritative legacy ImageMagick web site is <a href="https://legacy.imagemagick.org/">https://legacy.imagemagick.org</a>. The source code repository is <a href="https://github.com/ImageMagick/ImageMagick" target="_blank">https://github.com/ImageMagick/ImageMagick6</a>.  The current release of ImageMagick is <a href="<?php echo $_SESSION['RelativePath']?>/../script/download.php"><?php echo MagickLibVersionText . MagickLibSubversion; ?></a>. You can find a newer, recommended, release of ImageMagick, version 7, at <a href="https://imagemagick.org/" target="_blank">https://imagemagick.org</a>.</p>
