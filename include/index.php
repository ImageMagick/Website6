...
<p>As an analog to linear (RGB) and non-linear (sRGB) color colorspaces, as of ImageMagick 6.9.9-28, we introduce the sGray colorspace.  Gray is linear grayscale and sGray is non-linear.</p>
