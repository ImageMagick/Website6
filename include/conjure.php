...
<ul><pre class="bg-light"><code>conjure -dimensions 400x400 msl:incantation.msl
</code></pre></ul>

<p>The MSL script <a href="<?php echo $_SESSION['RelativePath']?>/../source/incantation.msl">incantation.msl</a> used above is here:</p>

<ul><pre class="bg-light"><code>&lt;?xml version="1.0" encoding="UTF-8"?&gt;
&lt;image&gt;
...
<ul><pre class="bg-light"><code>msl:font-metrics.pixels_per_em.x
