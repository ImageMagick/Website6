...
<pre class="bg-light"><code>convert rose.jpg -sharpen 0x1 reconstruct.jpg
...
<pre class="bg-light"><code>-> compare -verbose -metric mae rose.jpg reconstruct.jpg difference.png
Image: rose.jpg
...
<pre class="bg-light"><code>-> compare -channel red -metric PSNR rose.jpg reconstruct.jpg difference.png
19.63
</code></pre>

<p>If your image contains an alpha channel (transparency) you need to explicitly include it in the comparison:</p>

<pre class="bg-light"><code>-> compare -channel rgba -metric PSNR rose.jpg reconstruct.jpg difference.png
19.63
</code></pre>

<p>If you just want the overall image distortion, use this command:</p>

<pre class="bg-light"><code>-> compare -metric PSNR rose.jpg reconstruct.jpg difference.png
28.31
</code></pre>
...
<pre class="bg-light"><code>-> compare -metric RMSE -subimage-search logo.png wizard.jpg similarity.gif
