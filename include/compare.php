...
<pre class="highlight"><code>convert rose.jpg -sharpen 0x1 reconstruct.jpg
...
<pre class="highlight"><code>-> compare -verbose -metric mae rose.jpg reconstruct.jpg difference.png
Image: rose.jpg
...
<pre class="highlight"><code>-> compare -channel red -metric PSNR rose.jpg reconstruct.jpg difference.png
19.63
</code></pre>

<p>Or, if you just want the overall image distortion, use this command:</p>

<pre class="highlight"><code>-> compare -metric PSNR rose.jpg reconstruct.jpg difference.png
28.31
</code></pre>
...
<pre class="highlight"><code>-> compare -metric RMSE -subimage-search logo.png wizard.jpg similarity.gif
...
<p>The compare program returns 2 on error otherwise 0 if the images are similar or 1 if they are dissimilar as defined by the metric and fuzz.  The normalized cross correlation error metric is an exception. For this metric, 1 is interpreted as two identical images.</p>
