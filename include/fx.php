...
<ul><pre class="highlight"><samp>convert -size 64x64 canvas:black -channel blue -fx "1/2" fx_navy.png
</samp></pre></ul>
...
<ul><pre class="highlight"><samp>convert rose: \
...
<ul><pre class="highlight"><samp>convert -size 70x70 canvas: \
...
<ul><pre class="highlight"><samp>convert photo.jpg -fx 'iso=32; rone=rand(); rtwo=rand(); \
...
<ul><pre class="highlight"><samp>convert -size 400x400 xc:black -colorspace gray -fx " \
  Xi=2.4*i/w-1.2; \
  Yj=2.4*j/h-1.2; \
...
<ul><pre class="highlight"><samp>convert xc: -channel gray -fx " \
...
<ul><pre class="highlight"><samp>convert image1.jpg image2.jpg image3.jpg -fx "(u+u[2])/2.0" image.jpg
</samp></pre></ul>
...
<ul><pre class="highlight"><samp>convert -channel red logo: -flop logo: -resize "20%" -fx "(u+v)/2" image.jpg
</samp></pre></ul>
...
<ul><pre class="highlight"><samp>p[-1].g      green value of pixel to the immediate left of the current pixel
...
<ul><pre class="highlight"><samp>p{0,0}.r     red value of the pixel in the upper left corner of the image
...
<ul><pre class="highlight"><samp>convert alpha.png beta.png -channel red -fx "(u.g+v.g)/2" gamma.png
</samp></pre></ul>
...
<ul><pre class="highlight"><samp>convert canvas:'rgb(25%,50%,75%)' rose: -colorspace rgb  \
...
<ul><pre class="highlight"><samp>convert rose: -duplicate 29 -virtual-pixel Gray -distort SRT '%[fx:360.0*t/n]' \
