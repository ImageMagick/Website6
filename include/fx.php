...
<pre class="highlight"><code>convert -size 400x400 xc:black -colorspace gray -fx " \
  Xi=2.4*i/w-1.2; \
  Yj=2.4*j/h-1.2; \
...
<pre class="highlight"><code>convert xc: -channel gray -fx " \
...
<dl class="row">
  ...
  <dt class="col-md-4"> array: </dt>
    <dd class="col-md-8">an image offers array storage (e.g. p[-1,-1].r) bounded by its width and height.  An image sequence represents multiple arrays (e.g. u.p[0,0].r, v.p[0,0].r).  Storage is limited to floating point values.</dd>
