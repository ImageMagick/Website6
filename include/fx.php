...
<pre><code>convert -size 64x64 canvas:black -channel blue -fx "1/2" fx_navy.png
</code></pre>
...
<pre><code>convert -size 70x70 canvas: \
...
<pre><code>convert photo.jpg -fx \'iso=32; rone=rand(); rtwo=rand(); \
...
<pre><code>convert image1.jpg image2.jpg image3.jpg -fx "(u+u[2])/2.0" image.jpg
</code></pre>
...
<pre><code>convert -channel red logo: -flop logo: -resize "20%" -fx "(u+v)/2" image.jpg
</code></pre>
...
<pre><code>p[-1].g      green value of pixel to the immediate left of the current pixel
...
<pre><code>p{0,0}.r     red value of the pixel in the upper left corner of the image
...
<pre><code>convert alpha.png beta.png -channel red -fx "(u.g+v.g)/2" gamma.png
</code></pre>
...
<pre><code>convert rose: -duplicate 29 -virtual-pixel Gray -distort SRT '%[fx:360.0*t/n]' \
