...
<dt class="col-md-4"> <code>if(</code><var>condition test</var>, <var>true-expression</var>, <var>false-expression</var><code>)</code></dt><dd class="col-md-8"> interpret expression depending on condition</dd>
