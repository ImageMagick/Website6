...
<ul><pre class="bg-light text-dark"><samp>convert -size 64x64 canvas:black -channel blue -fx "1/2" fx_navy.png
</samp></pre></ul>
...
<ul><pre class="bg-light text-dark"><samp>convert rose: \
...
<ul><pre class="bg-light text-dark"><samp>convert -size 70x70 canvas: \
...
<ul><pre class="bg-light text-dark"><samp>convert photo.jpg -fx 'iso=32; rone=rand(); rtwo=rand(); \
...
<ul><pre class="bg-light text-dark"><samp>convert -size 400x400 xc:black -colorspace gray -fx " \
  Xi=2.4*i/w-1.2; \
  Yj=2.4*j/h-1.2; \
...
<ul><pre class="bg-light text-dark"><samp>convert xc: -channel gray -fx " \
...
<ul><pre class="bg-light text-dark"><samp>convert image1.jpg image2.jpg image3.jpg -fx "(u+u[2])/2.0" image.jpg
</samp></pre></ul>
...
<ul><pre class="bg-light text-dark"><samp>convert alpha.png beta.png -channel red -fx "(u.g+v.g)/2" gamma.png
</samp></pre></ul>
...
<ul><pre class="bg-light text-dark"><samp>convert canvas:'rgb(25%,50%,75%)' rose: -colorspace gray  \
...
<ul><pre class="bg-light text-dark"><samp>convert rose: -duplicate 29 -virtual-pixel Gray -distort SRT '%[fx:360.0*t/n]' \
