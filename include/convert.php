...
<pre class="highlight"><code>convert rose.jpg rose.png
</code></pre>

<p>Next, we reduce the image size before it is written to the PNG format:</p>

<pre class="highlight"><code>convert rose.jpg -resize 50% rose.png
</code></pre>
...
<pre class="highlight"><code>convert -size 320x85 canvas:none -font Bookman-DemiItalic -pointsize 72 \
...
<pre class="highlight"><code>convert input.png -colorspace RGB +sigmoidal-contrast 11.6933 \
