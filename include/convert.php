...
<pre class="bg-light text-dark mx-4"><code>convert rose.jpg rose.png
</code></pre>

<p>Next, we reduce the image size before it is written to the PNG format:</p>

<pre class="bg-light text-dark mx-4"><code>convert rose.jpg -resize 50% rose.png
</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert -size 320x85 canvas:none -font Bookman-DemiItalic -pointsize 72 \
...
<pre class="bg-light text-dark mx-4"><code>convert input.png -colorspace RGB +sigmoidal-contrast 11.6933 \
  -define filter:filter=Sinc -define filter:window=Jinc -define filter:lobes=3 \
  -resize 400% -sigmoidal-contrast 11.6933 -colorspace sRGB output.png');
</code></pre>

<p>You can find additional examples of using <code>convert</code> in <a href="https://legacy.imagemagick.org/Usage/">Examples of ImageMagick Usage</a>.</p>
