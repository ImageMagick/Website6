...
<ul><pre class="highlight"><code>-> identify -list resource
Resource limits:
  Width: 100MP
  Height: 100MP
  Area: 25.181GB
...
<ul><pre class="highlight"><code>-> convert -debug cache logo: -sharpen 3x2 null:
...
<ul><pre class="highlight"><code>-> convert -bench 10 model.png -sharpen 5x2 null:
...
<ul><pre class="highlight"><code>convert logo: -process \"analyze\" -verbose info:
Image: logo:
