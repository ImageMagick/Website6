...
<pre class="bg-light text-dark"><code>mogrify -resize 50% rose.jpg
</code></pre>
...
<pre class="bg-light text-dark"><code>mogrify -resize 256x256 *.jpg
</code></pre>

<p>Finally, we convert all our PNG images in a folder to the JPEG format:</p>

<pre class="bg-light text-dark"><code>mogrify -format jpg *.png
</code></pre>
