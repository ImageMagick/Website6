...
<pre class="bg-light text-dark mx-4"><code>mogrify -resize 50% rose.jpg
</code></pre>
...
<ul>
  ...
  <img style="margin-top:12px; margin-bottom: 11px;" src="<?php echo $_SESSION['RelativePath']?>/../image/rose.png" width="35" height="23" alt="rose" />
  </a>
</ul>

<p>You can resize all your JPEG images in a folder to a maximum dimension of 256x256 with this command:</p>

<pre class="bg-light text-dark mx-4"><code>mogrify -resize 256x256 *.jpg
</code></pre>

<p>Finally, we convert all our PNG images in a folder to the JPEG format:</p>

<pre class="bg-light text-dark mx-4"><code>mogrify -format jpg *.png
</code></pre>
...
<p>You can find additional examples of using <code>mogrify</code> in <a href="https://legacy.imagemagick.org/Usage/">Examples of ImageMagick Usage</a>.</p>
...
transparent, extract, background, or shape the alpha channel</td>
  ...
  <tr>
    <td><a href="<?php echo $_SESSION['RelativePath']?>/../script/command-line-options.php#format">-format <var>type</var></a></td>
  ...
  <tr>
    <td><a href="<?php echo $_SESSION['RelativePath']?>/../script/command-line-options.php#ift">-ifft</a></td>
  ...
  <tr>
    <td><a href="<?php echo $_SESSION['RelativePath']?>/../script/command-line-options.php#reshape">-reshape <var>geometry</var></a></td>
