...
<ul><pre class="pre-scrollable bg-light text-dark"><code>&lt;policymap>
...
<ul><pre class="bg-light text-dark"><code>$ convert https://imagemagick.org/image/wizard.png wizard.jpg
...
<ul><pre class="bg-light text-dark"><code>&lt;policy domain="coder" rights="write" pattern="{PDF,PS,PS2,PS3,XPS}" /></code></pre></ul>
...
<ul><pre class="pre-scrollable bg-light text-dark"><code>-> identify -list policy
