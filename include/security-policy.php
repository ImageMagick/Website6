...
<ul><pre class="highlight"><code>$ convert https://imagemagick.org/image/wizard.png wizard.jpg
convert: attempt to perform an operation not allowed by the security policy `HTTPS'
convert: no images defined `wizard.jpg'</code></pre></ul>
...
<ul><pre class="highlight"><code>&lt;policy domain="delegate" rights="none" pattern="*" />
...
<ul><pre class="highlight"><code>&lt;policy domain="module" rights="write" pattern="{PDF,PS,PS2,PS3,XPS}" /></code></pre></ul>
...
<ul><pre class="highlight"><code>&lt;policy domain="system" name="memory-map" value="anonymous"/>
&lt;policy domain="cache" name="memory-map" value="anonymous"/>
...
<ul><pre class="highlight"><code>&lt;policy domain="system" name="max-memory-request" value="256MiB"/> </code></pre></ul>
...
<ul><pre class="highlight"><code>&lt;policy domain="resource" name="list-length" value="64"/></code></pre></ul>
...
<ul><pre class="highlight"><code>&lt;policy domain="module" rights="none" pattern="{ps,pdf,xps}/></code></pre></ul>
...
<ul><pre class="highlight"><code>&lt;policy domain="system" name="font" value="/usr/share/fonts/arial-unicode.ttf"/></code></pre></ul>

<p>You can verify your policy changes are in effect with this command:</p>

<ul><pre class="pre-scrollable highlight"><code>-> identify -list policy
...
<ul><pre class="highlight"><code>static const char
