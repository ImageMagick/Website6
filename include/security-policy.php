...
<pre class="highlight"><code>$ convert https://www.imagemagick.org/image/wizard.png wizard.jpg
...
<pre class="highlight"><code>&lt;policy domain="coder" rights="none" pattern="{EPS,PS,PS2,PS3,PDF,XPS}" /></code></pre>
