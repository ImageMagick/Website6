...
<pre class="highlight"><code>$ convert https://imagemagick.org/image/wizard.png wizard.jpg
...
<pre class="highlight"><code>&lt;policy domain="system" name="font" value="/usr/local/etc/ImageMagick-7/arial-unicode.ttf"/></code></pre>
