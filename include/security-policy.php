...
<ul>
<dt><a href="<?php echo $_SESSION['RelativePath']?>/../source/open-policy.xml">open</a></dt>
...
<dt><a href="<?php echo $_SESSION['RelativePath']?>/../source/limited-policy.xml">limited</a></dt>
...
<dt><a href="<?php echo $_SESSION['RelativePath']?>/../source/secure-policy.xml">secure</a></dt>
...
<dt><a href="<?php echo $_SESSION['RelativePath']?>/../source/websafe-policy.xml">websafe</a></dt>
...
<p>As of ImageMagick 6.9.10-11, you can programmatically set the ImageMagick security policy with SetMagickSecurityPolicy() (MagickCore) or MagickSetSecurityPolicy() (MagickWand).</p>

<p>As of ImageMagick version 6.9.10-11, you can set a <samp>module</samp> security policy.  For example, to prevent Postscript or PDF interpretation, use:</p>
<pre class="bg-light text-dark mx-4"><samp>&lt;policy domain="module" rights="none" pattern="{ps,pdf,xps}/></samp></pre>

<p>As of ImageMagick version 6.9.10-52, you can set a <samp>font</samp> policy.  Specify a path to a Unicode font that ImageMagick defaults to whenever the user does not specify a font preference:</p>
