...
<pre class="bg-light text-dark mx-4"><code>convert rose.jpg -encipher passphrase.txt rose.png
</code></pre>

<p>Here we encipher an image using another image as the passphrase:</p>

<pre class="bg-light text-dark mx-4"><code>convert rose.jpg -encipher smiley.gif rose.png
</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert rose.png -decipher passphrase.txt rose.jpg
</code></pre>
...
Examples <a href="https://legacy.imagemagick.org/Usage/transform/#encipher"
