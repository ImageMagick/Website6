...
<pre class="bg-light text-dark mx-4"><code>convert -size 320x90 canvas:none -stroke snow4 -size 1x90 -tile gradient:white-snow4 \
...
<pre class="bg-light text-dark mx-4"><code>convert *.jpg images.gif</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert -size 640x480 -depth 8 rgb:image image.png</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert -size 640x480 pattern:checkerboard checkerboard.png</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert fd:3 fd:4 -append fd:5</code></pre>

<p>When needed, explicit image formats can be given as mentioned earlier, as in the following.
</p>

<pre class="bg-light text-dark mx-4"><code>convert gif:fd:3 jpg:fd:4 -append tif:fd:5</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert 'images.gif[0]' image.png</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert 'images.gif[0-3]' images.mng</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert 'images.gif[3,2,4]' images.mng</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert '*.jpg[120x120+10+5]' thumbnail%03d.png</code></pre>
...
<pre class="bg-light text-dark mx-4">frame001.jpg
frame002.jpg
frame003.jpg</pre>

<p>We then expect this command:</p>

<pre class="bg-light text-dark mx-4"><code>convert @myimages.txt mymovie.gif</code></pre>
...
<pre class="bg-light text-dark mx-4">'my title.jpg'</pre>
...
<pre class="bg-light text-dark mx-4"><code>convert image-%d.jpg[1-5]</code></pre>

<p>causes ImageMagick to attempt to read images with these filenames:
</p>

<pre class="bg-light text-dark mx-4">image-1.jpg
image-2.jpg
image-3.jpg
image-4.jpg
image-5.jpg</pre>
...
<pre class="bg-light text-dark mx-4"><code>convert logo: gif:- | display -define stream:buffer-size=0 gif:-</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert -channel RGB wand.png wizard.png images.png</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert wand.png -negate wizard.png images.png</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert mikayla.png picnic.png beach.png -append vacation.png</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert logo: -resize '200%' bigWiz.png
...
<pre class="bg-light text-dark mx-4"><code>convert logo: -resize '100' wiz1.png
...
<pre class="bg-light text-dark mx-4"><code>convert wand.gif \( wizard.gif -rotate 30 \) +append images.gif</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert image.jpg rgb:image</code></pre>
...
<pre class="bg-light text-dark mx-4">image-0.jpg
image-1.jpg
image-2.jpg</pre>
...
<pre class="bg-light text-dark mx-4"><code>convert rose: -set filename:area '%wx%h' 'rose-%[filename:area].png'</code></pre>

<p>writes an image with this filename:
</p>

<pre class="bg-light text-dark mx-4">rose-70x46.png</pre>
...
<pre class="bg-light text-dark mx-4"><code>convert -define stream:buffer-size=0 logo: gif:- | display gif:-</code></pre>
</div>
