...
<pre class="highlight"><code>convert image.jpg image.png </code></pre>

<p>Or it can be complex with a plethora of <a href="#option">options</a>, as in the following:</p>

<pre class="highlight"><code>convert label.gif +matte \
...
<pre class="highlight"><code>convert -size 320x90 canvas:none -stroke snow4 -size 1x90 -tile gradient:white-snow4 \
...
<pre class="highlight"><code>convert *.jpg images.gif</code></pre>
...
<pre class="highlight"><code>convert -size 640x480 -depth 8 rgb:image image.png</code></pre>
...
<pre class="highlight"><code>convert -size 640x480 pattern:checkerboard checkerboard.png</code></pre>
...
<pre class="highlight"><code>convert logo: gif:- | display gif:-</code></pre>
...
<pre class="highlight"><code>convert rose: gif:- | magick - -resize "200%" bigrose.jpg'</code></pre>
...
<pre class="highlight"><code>convert fd:3 fd:4 -append fd:5</code></pre>

<p>When needed, explicit image formats can be given as mentioned earlier, as in the following.
</p>

<pre class="highlight"><code>convert gif:fd:3 jpg:fd:4 -append tif:fd:5</code></pre>
...
<pre class="highlight"><code>convert 'images.gif[0]' image.png</code></pre>
...
<pre class="highlight"><code>convert 'images.gif[0-3]' images.mng</code></pre>
...
<pre class="highlight"><code>convert 'images.gif[3,2,4]' images.mng</code></pre>
...
<pre class="highlight"><code>convert -size 6000x4000 -depth 8 'rgb:image[600x400+1900+2900]' image.jpg</code></pre>

<p>
  You can get the same results with the <?php option("extract"); ?> option:
</p>

<pre class="highlight"><code>convert -size 6000x4000 -depth 8 -extract 600x400+1900+2900 rgb:image image.jpg</code></pre>
...
<pre class="highlight"><code>convert '*.jpg' -resize 120x120 thumbnail%03d.png</code></pre>
...
<pre class="highlight"><code>convert '*.jpg[120x120]' thumbnail%03d.png</code></pre>
...
<pre class="highlight"><code>convert '*.jpg' -crop 120x120+10+5 thumbnail%03d.png</code></pre>
...
<pre class="highlight"><code>convert '*.jpg[120x120+10+5]' thumbnail%03d.png</code></pre>
...
<pre class="highlight"><code>convert @myimages.txt mymovie.gif</code></pre>
...
<pre class="highlight"><code>convert image-%d.jpg[1-5]</code></pre>
...
<pre class="highlight"><code>convert logo: gif:- | display -define stream:buffer-size=0 gif:-</code></pre>
...
<pre class="highlight"><code>convert logo: -resize '200%' bigWiz.png
...
<pre class="highlight"><code>convert logo: -resize '100' wiz1.png
...
<pre class="highlight"><code>convert logo: -resize '10000@' wiz10000.png</code></pre>
...
<pre class="highlight"><code>convert logo: -region '100x200+10+20' -negate wizNeg1.png
...
<pre class="highlight"><code>convert wand.gif \( wizard.gif -rotate 30 \) +append images.gif</code></pre>
...
<pre class="highlight"><code>convert image.jpg rgb:image</code></pre>
...
<pre class="highlight"><code>convert rose: -set filename:area '%wx%h' 'rose-%[filename:area].png'</code></pre>
...
<pre class="highlight"><code>convert *.jpg +adjoin page-%d.pdf</code></pre>
...
<pre class="highlight"><code>convert -define stream:buffer-size=0 logo: gif:- | display gif:-</code></pre>
</div>
