...
<ul><pre class="bg-light text-dark"><code>convert image.jpg image.png </code></pre></ul>

<p>Or it can be complex with a plethora of <a href="#option">options</a>, as in the following:</p>

<ul><pre class="bg-light text-dark"><code>convert label.gif +matte \
...
<ul><pre class="bg-light text-dark"><code>convert -size 320x90 canvas:none -stroke snow4 -size 1x90 -tile gradient:white-snow4 \
  ...
  -append -background white -gravity center -extent 320x200 cylinder_shaded.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert *.jpg images.gif</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert -size 640x480 -depth 8 rgb:image image.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert -size 640x480 pattern:checkerboard checkerboard.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert logo: gif:- | display gif:-</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert rose: gif:- | magick - -resize "200%" bigrose.jpg'</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert fd:3 fd:4 -append fd:5</code></pre></ul>

<p>When needed, explicit image formats can be given as mentioned earlier, as in the following.
</p>

<ul><pre class="bg-light text-dark"><code>convert gif:fd:3 jpg:fd:4 -append tif:fd:5</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert 'images.gif[0]' image.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert 'images.gif[0-3]' images.mng</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert 'images.gif[3,2,4]' images.mng</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert -size 6000x4000 -depth 8 'rgb:image[600x400+1900+2900]' image.jpg</code></pre></ul>

<p>
  You can get the same results with the <?php option("extract"); ?> option:
</p>

<ul><pre class="bg-light text-dark"><code>convert -size 6000x4000 -depth 8 -extract 600x400+1900+2900 rgb:image image.jpg</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert '*.jpg' -resize 120x120 thumbnail%03d.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert '*.jpg[120x120]' thumbnail%03d.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert '*.jpg' -crop 120x120+10+5 thumbnail%03d.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert '*.jpg[120x120+10+5]' thumbnail%03d.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert @myimages.txt mymovie.gif</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert image-%d.jpg[1-5]</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert logo: gif:- | display -define stream:buffer-size=0 gif:-</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert -channel RGB wand.png wizard.png images.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert wand.png -negate wizard.png images.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert mikayla.png picnic.png beach.png -append vacation.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert logo: -resize '200%' bigWiz.png
...
magick logo: -resize '100x200!' dochThinWiz.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert logo: -resize '100' wiz1.png
...
<ul><pre class="bg-light text-dark"><code>convert logo: -resize '10000@' wiz10000.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert logo: -region '100x200+10+20' -negate wizNeg1.png
...
<ul><pre class="bg-light text-dark"><code>convert wand.gif \( wizard.gif -rotate 30 \) +append images.gif</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert image.jpg rgb:image</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert rose: -set filename:area '%wx%h' 'rose-%[filename:area].png'</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert *.jpg +adjoin page-%d.pdf</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert -define stream:buffer-size=0 logo: gif:- | display gif:-</code></pre></ul>
</div>
