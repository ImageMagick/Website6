...
<pre class="bg-light text-dark"><code>-> identify rose.jpg
...
<pre class="pre-scrollable bg-light text-dark"><code>-> identify -verbose rose.jpg
Image: rose.jpg
...
<pre class="bg-light text-dark"><code>-> identify -format "%[fx:w/72] by %[fx:h/72] inches" document.png
8.5 x 11 inches
</code></pre>

<p>The depth and dimensions of a raw image must be specified on the command line:</p>

<pre class="bg-light text-dark"><code>-> identify -depth 8 -size 640x480 image.raw
...
<pre class="bg-light text-dark"><code>-> identify -verbose -features 1 -moments -unique image.png
</code></pre>

<p>Here is a special define that outputs the location of the minimum or maximum pixel of the image:</p>

<pre class="bg-light text-dark"><code>identify -precision 5 -define identify:locate=maximum -define identify:limit=3 image.png
</code></pre>
