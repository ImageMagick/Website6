...
<p class="lead">Use the <code>composite</code> program to overlap one image over another.  See <a href="<?php echo $_SESSION['RelativePath']?>/../script/command-line-processing.php">Command Line Processing</a> for advice on how to structure your <code>composite</code> command or see below for example usages of the command.</p>
...
<pre class="bg-light text-dark mx-4"><code>composite -gravity center smile.gif  rose: rose-over.png
</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>convert -size 70x70 canvas:none -fill red -draw 'circle 35,35 10,30' red-circle.png
