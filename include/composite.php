...
<pre class="bg-light"><code>composite -gravity center smile.gif  rose: rose-over.png
</code></pre>
...
<pre class="bg-light"><code>convert -size 70x70 canvas:none -fill red -draw 'circle 35,35 10,30' red-circle.png
