...
<pre class="bg-light text-dark"><code>composite -gravity center smile.gif  rose: rose-over.png
</code></pre>
...
<pre class="bg-light text-dark"><code>convert -size 70x70 canvas:none -fill red -draw 'circle 35,35 10,30' red-circle.png
