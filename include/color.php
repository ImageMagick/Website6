...
<pre class="bg-light text-dark mx-4"><code>convert -bordercolor lime -border 10 image.jpg image.png
...
convert -bordercolor 'rgb(0,100%,0)' -border 10 image.jpg image.png</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>#f00                       4-bit  #rgb
#ff0000                    8-bit  #rrggbb
...
<pre class="bg-light text-dark mx-4"><code>rgb(255, 0, 0)                 range 0 - 255
...
<pre class="bg-light text-dark mx-4"><code>hsb(0,   100%,  100%)    or    hsb(0,   255,   255)       full red
...
<pre class="bg-light text-dark mx-4"><code>hsl(0,   100%,  50%)     or    hsl(0,   255,   127.5)     full red
...
<pre class="bg-light text-dark mx-4"><code>hsb(120, 100%,  100%)              full green in hsb
...
<pre class="bg-light text-dark mx-4"><code>cielab(62.253188, 23.950124, 48.410653)</code></pre>
...
<pre class="bg-light text-dark mx-4"><code>$ convert xc:#CD853F -colorspace LAB txt:
...
<pre class="bg-light text-dark mx-4"><code>device-gray(0.5)
