...
<pre class="highlight"><code>convert -bordercolor lime -border 10 image.jpg image.png
...
<p>Non-linear gray values are conveniently defined with a name:</p>

<pre class="highlight"><code>
gray50            near mid gray
gray100           white</code></pre>

<p>Linear gray values are a single intensity value or an intensity value and an alpha value:</p>
