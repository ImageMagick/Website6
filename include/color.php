...
<ul><pre class="bg-light text-dark"><code>convert -bordercolor lime -border 10 image.jpg image.png
...
convert -bordercolor 'rgb(0,100%,0)' -border 10 image.jpg image.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>#f00                      #rgb
#ff0000                   #rrggbb
#ff0000ff                 #rrggbbaa
...
<ul><pre class="bg-light text-dark"><code>rgb(255, 0, 0)                 range 0 - 255
...
<ul><pre class="bg-light text-dark"><code>hsb(0,   100%,  100%)    or    hsb(0,   255,   255)       full red
...
<ul><pre class="bg-light text-dark"><code>hsl(0,   100%,  50%)     or    hsl(0,   255,   127.5)     full red
...
<ul><pre class="bg-light text-dark"><code>hsb(120, 100%,  100%)              full green in hsb
...
<ul><pre class="bg-light text-dark"><code>cielab(62.253188, 23.950124, 48.410653)</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>$ convert xc:#CD853F -colorspace LAB txt:
# ImageMagick pixel enumeration: 1,1,65535,cielab
0,0: (40470.8,38266.6,12314.5)  #9E17957BB01A  cielab(61.7544,21.3973,47.9163)

$ convert xc:"cielab(61.7544,21.3973,47.9163)" -colorspace sRGB -depth 8 peru.png</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>device-gray(0.5)
