...
<ul><pre class="bg-light"><code>convert myimage.jpg -colorspace RGB -resize 200% -colorspace sRGB mybigimage.jpg</code></pre></ul>

<p>To declare that an image is linear RGB rather than sRGB, you can use the set option:</p>

<ul><pre class="bg-light"><code>convert myimage.png -set colorspace RGB myRGBimage.png</code></pre></ul>
...
<ul><pre class="bg-light"><code>convert myimage.png -colorspace RGB -separate myimage_channels_%d.png</code></pre></ul>
...
<ul><pre class="bg-light"><code>convert myimage.png -separate myimage_channels_%d.png
...
<ul><pre class="bg-light"><code>convert myimage.png -set colorspace RGB -separate myimage_channels_%d.png
...
<ul><pre class="bg-light"><code>convert myimage.png -colorspace HSL -separate myimage_channels_%d.png
convert myimage_channels_*.png -set colorspace HSL -combine -colorspace sRGB myimage2.png</code></pre></ul>

<ul><pre class="bg-light"><code>convert myimage.png -set colorspace RGB -colorspace HSL -separate myimage_channels_%d.png
