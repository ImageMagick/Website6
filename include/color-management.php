...
<pre class="highlight"><code>convert myimage.jpg -colorspace RGB -resize 200% -colorspace sRGB mybigimage.jpg</code></pre>
...
<pre class="highlight"><code>convert myimage.png -set colorspace RGB -separate myimage_channels_%d.png</code></pre>
...
<pre class="highlight"><code>convert myimage.png -colorspace HSL -separate myimage_channels_%d.png
convert myimage_channels_*.png -set colorspace HSL -combine -colorspace sRGB myimage2.png</code></pre>

<pre class="highlight"><code>convert myimage.png -set colorspace RGB -colorspace HSL -separate myimage_channels_%d.png
