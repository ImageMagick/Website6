...
<dl>
  <dt class="col-md-12"><a href="https://networkredux.com"> <img class="clearfix" src="https://imagemagick.org/image/networkredux.png" width="140" height="31" alt="[Network Redux]" /></a>   We manage everything so you don't have to</dt><br/>
...
<p>Open an issue on the <a href="https://github.com/ImageMagick6/ImageMagick/">GitHub repository</a> if you think you have found a bug or security vulnerability. Open a pull request to the repository if you have a fix. Post to the <a href="https://github.com/ImageMagick6/ImageMagick/discussions">discussions</a> forum if you want to propose an enhancement for discussion.</p>
...
<h3>Bitcoin</h3>
<p>Our Bitcoin Address is: <kbd>bc1qd7lckxu36ceupgt4wpnvnug3dr8jcnpqxsla2k</kbd>.  Or you can reference the below QR code:</p>
<ul>
<dt class="col-md-4"><img src="<?php echo $_SESSION['RelativePath']?>/../image/litecoin.png" alt="Click to Donate to ImageMagick via Bitcoin" title="Click to Donate to ImageMagick via Bitcoin" width="297" height="297" /></dt>
</ul>
</fieldset>
<br/>
