...
<ul>
<dt class="col-md-4"><img src="<?php echo $_SESSION['RelativePath']?>/../image/litecoin.svg" alt="Click to Donate to ImageMagick via Bitcoin" title="Click to Donate to ImageMagick via Bitcoin" width="300" height="300" /></dt>
</ul>
</fieldset>
<br/>
