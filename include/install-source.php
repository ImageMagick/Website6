...
<ul><pre class="highlight"><code>identify -version
</code></pre></ul>
...
<ul><pre class="highlight"><code>/usr/local/bin/convert logo: logo.gif
</code></pre></ul>
...
<ul><pre class="highlight"><code>make check
</code></pre></ul>
...
<ul><pre class="highlight"><code>git clone -b ImageMagick-Windows-6 --single-branch https://github.com/ImageMagick/ImageMagick6-Windows.git ImageMagick-Windows-6</code></pre></ul>
...
<ul><pre class="highlight"><code>unzip ImageMagick-windows.zip</code></pre></ul>
...
<p><img class="img-fluid me-auto d-block" src="<?php echo $_SESSION['RelativePath']?>/../image/configure.jpg" alt="[configure]" /></p>
...
<ul><pre class="highlight"><code>validate
</code></pre></ul>
