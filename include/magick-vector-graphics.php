...
<ul><pre class="highlight"><code>convert -size 100x60 canvas:skyblue -fill white -stroke black \
...
<ul><pre class="pre-scrollable highlight"><code>push graphic-context
  viewbox 0 0 624 369
...
<ul><pre class="highlight"><code>convert mvg:piechart.mvg piechart.png
</code></pre></ul>
...
<ul><pre class="highlight"><code>convert mvg:piechart.svg piechart.jpg
</code></pre></ul>
...
<ul><pre class="pre-scrollable highlight"><code>(void) PushDrawingWand(draw_wand);
{
...
<ul><pre class="highlight"><code>push graphic-context
...
<ul><pre class="highlight"><code>push pattern id x,y width,height
 push graphic-context
  [ drawing commands ]
 pop graphic-context
pop pattern
...
<ul><pre class="highlight"><code>push defs
...
<ul><pre class="highlight"><code>stroke url(#%s)
</code></pre></ul>

<p>or</p>

<ul><pre class="highlight"><code>fill url(#%s)
</code></pre></ul>
...
<ul><pre class="highlight"><code>point
replace
floodfill
filltoborder
reset</code></pre></ul></td>
  </tr>
  <tr>
...
<ul><pre class="highlight"><code>none
line-through
overline
...
<ul><pre class="highlight"><code>all
normal
ultra-condensed
extra-condensed
condensed
...
<ul><pre class="highlight"><code>NorthWest
North
NorthEast
West
Center
...
<ul><pre class="highlight"><code>butt
round
...
<ul><pre class="highlight"><code>bevel
miter
