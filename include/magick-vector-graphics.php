...
<ul><pre class="bg-light text-dark"><code>convert -size 100x60 canvas:skyblue -fill white -stroke black \
...
<ul><pre class="bg-light text-dark"><code>convert mvg:piechart.mvg piechart.png
</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>convert mvg:piechart.svg piechart.jpg
</code></pre></ul>
