...
<table class="table table-sm table-hover">
  ...
  <br /><br />
<pre class="highlight">Quantum Depth     Valid Range (Decimal)   Valid Range (Hex)
    8             0-255                   00-FF
  ...
  <br /><br />
<pre class="highlight">Quantum Depth   Virtual Memory
     8               3MB
    16               8MB
    32              15MB
</pre></td>
...
<p>Now lets build ImageMagick:</p>
	  ...
	  <p><a href="<?php echo $_SESSION['RelativePath']?>/../script/mirror.php">Download</a> the ImageMagick source distribution and verify the distribution against its <a href="https://imagemagick.org/download/digest.rdf">message digest</a>.</p>
