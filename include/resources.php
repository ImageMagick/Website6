...
<ul><pre class="bg-light text-dark"><code>&lt;policy domain="resource" name="area" value="100KP"/></code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>&lt;policy domain="resource" name="width" value="8KP"/></code></pre></ul>

To limit the elapsed time of any ImageMagick command to 5 minutes, use this policy:

<ul><pre class="bg-light text-dark"><code>&lt;policy domain="resource" name="time" value="300"/></code></pre></ul>
...
&lt;<var>current directory</var>&gt;</code></pre></ul>
...
&lt;<var>client path</var>&gt;</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>$MAGICK_HOME/lib/ImageMagick-<?php echo(MagickLibVersionText); ?>/modules-Q16/coders
...
$XDG_CACHE_HOME/ImageMagick
$HOME/.config/ImageMagick
&lt;<var>client path</var>&gt;/lib/ImageMagick-<?php echo(MagickLibVersionText); ?>/modules-Q16/coders</code></pre></ul>
...
<ul><pre class="bg-light text-dark"><code>$MAGICK_HOME/lib/ImageMagick-<?php echo(MagickLibVersionText); ?>/modules-Q16/filters
...
$XDG_CACHE_HOME/ImageMagick
$HOME/.config/ImageMagick
&lt;<var>client path</var>&gt;/lib/ImageMagick-<?php echo(MagickLibVersionText); ?>/modules-Q16/filters</code></pre></ul>
