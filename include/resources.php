...
<pre class="bg-light text-dark mx-4"><code>&lt;policy domain="resource" name="area" value="100KP"/></code></pre>
...
<pre class="bg-light text-dark mx-4"><code>&lt;policy domain="resource" name="width" value="8KP"/></code></pre>
