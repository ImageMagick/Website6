...
<pre class="bg-light"><code>magick bilevel.tif -define ps:imagemask eps3:stencil.ps
</code></pre>
...
<pre class="bg-light"><code>-define registry:temporary-path=/data/tmp
</code></pre>
...
<pre class="bg-light"><code>-define png:include-chunk=none,gAMA
</code></pre>
...
<pre class="bg-light"><code>-define png:exclude-chunk=EXIF,iCCP,iTXt,sRGB,tEXt,zCCP,zTXt,date</code></pre>
