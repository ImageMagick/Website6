...
<p class="lead">Use this ImageMagick sitemap to quickly jump to one of the areas of interest listed below.  If you can't find what you want on this page, try our <a href="<?php echo $_SESSION['RelativePath']?>/../script/search.php?q=ImageMagick&sa=">site search</a>.</p>
...
<dl class="magick-list-unstyled">
  <li><a href="<?php echo $_SESSION['RelativePath']?>/../script/mirror.php">Download ImageMagick</a>: ImageMagick source and binary distributions are available from a variety of FTP and Web mirrors.</li>
  <li> <dl class="magick-list-unstyled">
    ...
    <li><a href="https://github.com/ImageMagick/ImageMagick6">Git repository</a>: stable and development source releases.</li>
...
<dl class="magick-list-unstyled">
  ...
  <li><a href="https://legacy.imagemagick.org/discourse-server/viewtopic.php?t=25504">Canny edge detection</a>: extract edges from an image using the Canny technique.</li>
  <li><a href="<?php echo $_SESSION['RelativePath']?>/../script/color-management.php">Color management</a>: accurate color management with color profiles or in lieu of-- built-in gamma compression or expansion as demanded by the colorspace.</li>
  ...
  <li><a href="https://legacy.imagemagick.org/Usage/crop/">Decorate</a>: add a border or frame to an image.</li>
  <li><a href="https://legacy.imagemagick.org/Usage/fourier">Discrete Fourier transform</a>: implements the forward and inverse DFT.</li>
  ...
  <li><a href="https://legacy.imagemagick.org/discourse-server/viewtopic.php?t=26480">Kuwahara filter</a>: apply an edge perserving noise and color reduction filter to an image.</li>
  ...
  <li><a href="https://legacy.imagemagick.org/discourse-server/viewtopic.php?t=25504">Mean-shift</a>: apply a color reduction technique to an image.</li>
  ...
  <li><a href="https://legacy.imagemagick.org/Usage/blur/">Special effects</a>: blur, sharpen, threshold, or tint an image.</li>
  <li><a href="https://legacy.imagemagick.org/Usage/text/">Text &amp; comments</a>: insert descriptive or artistic text in an image.</li>
  ...
  <li><a href="https://legacy.imagemagick.org/Usage/resize/">Transform</a>: resize, rotate, crop, or trim an image.</li>
