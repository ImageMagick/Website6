...
<ul><pre class="bg-light text-dark"><code>stream -map rgb -storage-type char image.jpg pixels.dat
...
<ul><pre class="bg-light text-dark"><code>stream -map i -storage-type double -extract 100x100+30+40 image.tif gray.raw
</code></pre></ul>

<p>You can also associate the region to extract with the image filename:</p>

<ul><pre class="bg-light text-dark"><code>stream -map i -storage-type double 'image.tif[100x100+30+40]' gray.raw
</code></pre></ul>
...
<table class="table table-sm table-hover">
  ...
  <tr>
    <td><a href="<?php echo $_SESSION['RelativePath']?>/../script/command-line-options.php#stream-map">-map <var>components</var></a></td>
  ...
  <tr>
    <td><a href="<?php echo $_SESSION['RelativePath']?>/../script/command-line-options.php#storage-type">-storage-type <var>type</var></a></td>
