...
<pre><code>stream -map rgb -storage-type char image.jpg pixels.dat
...
<pre><code>stream -map i -storage-type double -extract 100x100+30+40 image.tif gray.raw
</code></pre>

<p>You can also associate the region to extract with the image filename:</p>

<pre><code>stream -map i -storage-type double 'image.tif[100x100+30+40]' gray.raw
</code></pre>
