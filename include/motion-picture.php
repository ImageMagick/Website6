...
<ul><pre class="bg-light"><code>identify -verbose bluebells.dpx
</code></pre></ul>

<p>To identify a particular property, try this:</p>

<ul><pre class="bg-light"><code>identify -format "%[dpx:television.time.code]" bluebells.dpx
</code></pre></ul>

<p>Finally, to set a property:</p>

<ul><pre class="bg-light"><code>convert bluebells.dpx -define dpx:television.time.code=10:00:02:15 bluebells-001.dpx
</code></pre></ul>
...
<ul><pre class="bg-light"><code>-set gamma 1.7
-set film-gamma 0.6
