...
<p>For example,</p>
<ul><pre class="highlight"><code>convert myImage.png -intensity Rec709Luminance -colorspace gray myImage.jpg</code></pre></ul>
...
<ul><pre class="highlight"><code>convert rose: -write-mask rose_bg_mask.png -modulate 110,100,33.3  +mask rose_blue.png</code></pre></ul>
...
<ul><pre class="highlight"><code>convert \( -page +10+20 first.png \) \( -page +100+200 second.png \) ...</code></pre></ul>
...
<ul><pre class="highlight"><code>convert ... -alpha discrete -blur 0x1 ...</code></pre></ul>
...
<ul><pre class="highlight"><code>convert wizard.png mask.pgm -channel-fx '| gray=>alpha' wizard-alpha.png</code></pre></ul>
<p>Use a similar command to define a read mask:</p>
<ul><pre class="highlight"><code>convert wizard.png mask.pgm -channel-fx '| gray=>read-mask' wizard-mask.png</code></pre></ul>
