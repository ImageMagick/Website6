...
<h1><a class="anchor" id="hdri"></a>High Dynamic Range Imaging</h1>
...
<h1><a class="anchor" id="channels"></a>Pixel Channels</h1>
...
<h1><a class="anchor" id="alpha"></a>Alpha</h1>
...
<h1><a class="anchor" id="colorspace"></a>Colorspace</h1>
...
<h1><a class="anchor" id="grayscale"></a>Grayscale</h1>
...
<h1><a class="anchor" id="mask"></a>Masks</h1>
<p>Version 7 supports masks for most image operators.  White pixels in a read mask ignores corresponding pixel in an image whereas white pixels in a write mask protects the corresponding pixel in the image.  From the command-line, you can associate a mask with an image with the <code>-read-mask</code> and <code>-write-mask</code> options.  This polarity is matches masks in version 6 of ImageMagick for ease of porting your workflow.  For convenience, we continue to support the <code>-mask</code> option in version 7 to match the behavior of version 6.</p>
...
<h1><a class="anchor" id="core"></a>MagickCore API</h1>
...
<h1><a class="anchor" id="core"></a>MagickWand API</h1>
...
<h1><a class="anchor" id="core"></a>Magick++ API</h1>
...
<h1><a class="anchor" id="headers"></a>Header Files</h1>
...
<h1><a class="anchor" id="deprecate"></a>Deprecated Features Removed</h1>
...
<h1><a class="anchor" id="cli"></a>Shell API or Command-line Interface</h1>
...
|    move to the next input image for the source of channel data (e.g. | gray=>alpha)</code></pre>
...
<h1><a class="anchor" id="summary"></a>Version 7 Change Summary</h1>
