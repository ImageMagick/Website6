...
using the '<code>Src</code>'  with the special <a href="<?php echo
$_SESSION['RelativePath']?>/../script/command-line-options.php#define"
...
<pre class="bg-light text-dark"><code>composite ... -blend 50x50 ...
</code></pre>
...
<pre class="bg-light text-dark"><code>convert ... -compose blend  -define compose:args=50,50 -composite ...
</code></pre>
...
<table class="table table-sm table-hover">
  ...
  <tr>
    ...
    <br/>Equivalent to "<code>composite</code>" <a href="<?php echo $_SESSION['RelativePath']?>/../script/command-line-options.php#dissolve">-dissolve</a>
  ...
  <tr>
    ...
    <br/>Equivalent to "<code>composite</code>" <a href="<?php echo $_SESSION['RelativePath']?>/../script/command-line-options.php#watermark">-watermark</a>
  ...
  <tr>
    ...
    <br/>Equivalent to "<code>composite</code>" <a href="<?php echo $_SESSION['RelativePath']?>/../script/command-line-options.php#displace">-displace</a>
  ...
  <tr>
    ...
    <br/>Equivalent to "<code>composite</code>" <a href="<?php echo
