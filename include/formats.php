...
<pre class="bg-light text-dark"><samp>identify -list format
</samp></pre>
...
<pre class="bg-light text-dark"><samp>-> identify -verbose image.jpg
Image: image.jpg
...
<pre class="bg-light text-dark"><samp>$ convert image.jpg -print "%[colorspace]\n" null:
sRGB
</samp></pre>
...
<pre class="bg-light text-dark"><samp>convert image.jpg -colorspace RGB -resize 50% -colorspace sRGB resize.jpg
</samp></pre>
...
<pre class="bg-light text-dark"><samp>convert lab.tif -resize 50% resize.jpg
</samp></pre>
...
<pre class="bg-light text-dark"><samp>convert \( -size 15x15 canvas:black canvas:white -append \) \
