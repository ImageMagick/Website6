...
<pre class="bg-light"><code>-> identify -verbose image.jpg
Image: image.jpg
...
<pre class="bg-light"><code>$ convert image.jpg -print "%[colorspace]\n" null:
sRGB
</code></pre>
...
<pre class="bg-light"><code>convert image.jpg -colorspace RGB -resize 50% -colorspace sRGB resize.jpg
</code></pre>
...
<pre class="bg-light"><code>convert lab.tif -resize 50% resize.jpg
</code></pre>
...
<pre class="bg-light"><code>convert \( -size 15x15 canvas:black canvas:white -append \) \
