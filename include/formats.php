...
<table class="table table-sm table-hover table-striped">
  ...
  <tr>
    ...
    <td>This format permits you to write to and read images from memory.  The image persists until you explicitedly delete it or the program exits.  For example, let's use the MPR to create a checkerboard:
<pre class="bg-light text-dark mx-4"><samp>convert \( -size 15x15 canvas:black canvas:white -append \) \
  ...
  -size 240x240 tile:mpr:checkers +set registry:mpr:checkers board.png
</samp></pre></td>
  </tr>
