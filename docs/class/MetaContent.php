  ...
  class MetaContent
  {
    ...
    function metadata($title)
    {
      ...
      */
      ...
      $meta.="    }\n";
      $meta.="    a.nav-link:hover,\n";
      $meta.="    a.dropdown-item:hover {\n";
      $meta.="      color: #ffc107 !important;\n";
      $meta.="      text-shadow: 0px 2px 4px rgba(255, 193, 7, 0.8);\n";
      $meta.="    }\n";
      $meta.="    .btn-outline-warning {\n";
      $meta.="      color: #cd7f32;\n";
      $meta.="      border-color: #cd7f32;\n";
      $meta.="    }\n";
      $meta.="    .navbar-brand {\n";
      $meta.="      color: #d4af37;\n";
      $meta.="      transition: color 0.3s ease, text-shadow 0.3s ease;\n";
      $meta.="    }\n";
      $meta.="    .navbar-brand:hover {\n";
      $meta.="      color: #e9c03d;\n";
      $meta.="      text-shadow: 0px 2px 4px rgba(203, 163, 120, 0.6);\n";
      $meta.="    }\n";
      $meta.="  </style>\n\n";
