...
<?php
  ...
  function SiteHeader($title,$topic)
  {
    ...
    $meta->name="ImageMagick: Legacy";
    $meta->url="https://legacy.imagemagick.org" .  $_SERVER['SCRIPT_NAME'];
    $meta->sameAs="https://github.com/ImageMagick6, https://x.com/imagemagick";
...
?>
  ...
  <footer class="text-center pt-5 my-5 text-body-secondary border-top">
   ...
   <br>
     ...
     <a href="https://github.com/ImageMagick/ImageMagick6/discussions">Contact Us</a>
   <br>
