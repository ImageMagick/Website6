...
<?php
  ...
  switch ($action)
  {
    case 'Send':
    {
      ...
      $mail->Send();
?>
      <p>Your message was sent.  Expect a reply within 24-48 hours if your message is on topic and is a sponsorship, license, security, or paid support issue.  For all other issues, post your message to the <a href="https://github.com/ImageMagick/ImageMagick6/discussions">discussions</a> service.</p>
...
?>
  ...
  <p class="lead">Post here for any of the issues listed below.  You can expect a response from our team if your issue is a sponsorship, <a href="https://imagemagick.org/license/">license</a>, security, or paid support issue.  If you require a response for any other issue, post to the ImageMagick public <a href="https://github.com/ImageMagick/ImageMagick6/discussions">forums</a>.  You can also post bug and security issues to the <a href="https://github.com/ImageMagick/ImageMagick6/issues">issues</a> forum.  Note, we do <u>not</u> offer sponsored links <u>nor do we respond to solicitations</u>.</p>
  <fieldset>
